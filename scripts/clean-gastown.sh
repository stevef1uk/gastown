...
echo ""
log_info "Next steps:"
echo "  1. Run '${YELLOW}gt up${NC}' to re-initialize the town"
echo "  2. Run '${YELLOW}gt rig create <name>${NC}' to create new rigs"
echo "  3. Run '${YELLOW}gt mountain <epic>${NC}' to start building"
echo ""
