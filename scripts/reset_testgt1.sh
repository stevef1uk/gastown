...
RIG_DIR="${GT_ROOT:-$HOME/gt}/testgt1/mayor/rig"
...
echo "Run: gt rig spec-index testgt1 --profiled to regenerate the workflow profile, then gt down && gt up --orchestrator-only"
