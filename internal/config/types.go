...
type OrchestratorConfig struct {
	...
	// PipelineOnly skips legacy autonomous pipeline and patrol LLM agents on gt up
	// (per-bead polecats, crew restore, town hq-polecat/hq-architect/hq-qa, deacon,
	// mechanic, witness, refinery). Orchestrated rig-flow roles still start.
	// Also available as gt up --orchestrator-only.
