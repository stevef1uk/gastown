...
func TestAgentEnv_RigPolecat(t *testing.T) {
	...
	assertEnv(t, env, "GT_ROLE", "mockrig/polecat")
	assertEnv(t, env, "GT_RIG", "mockrig")
	assertEnv(t, env, "BD_ACTOR", "mockrig/polecat")
	assertEnv(t, env, "GIT_AUTHOR_NAME", "mockrig/polecat")
	assertNotSet(t, env, "GT_POLECAT")
}
