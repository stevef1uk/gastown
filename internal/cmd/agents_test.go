...
func TestGuessSessionFromWorkerDir(t *testing.T) {
	...
	tests := []struct {
		...
		{"witness worker", "/town/gastown/witness/main", "gt-gastown-witness"},
		{"witness worker rig", "/town/gastown/witness/rig", "gt-gastown-witness"},
		{"refinery worker", "/town/gastown/refinery/main", "gt-gastown-refinery"},
		{"refinery worker rig", "/town/gastown/refinery/rig", "gt-gastown-refinery"},
