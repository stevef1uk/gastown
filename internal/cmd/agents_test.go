...
func TestGuessSessionFromWorkerDir(t *testing.T) {
	...
	tests := []struct {
		...
		{"witness worker", "/town/gastown/witness/main", "hq-gt-gastown-witness"},
		{"witness worker rig", "/town/gastown/witness/rig", "hq-gt-gastown-witness"},
		{"refinery worker", "/town/gastown/refinery/main", "hq-gt-gastown-refinery"},
		{"refinery worker rig", "/town/gastown/refinery/rig", "hq-gt-gastown-refinery"},
