...
- qa_verify_command: default rig-wide verify when no per-phase command applies — must run the **full unit test suite** (e.g. cd <layout> && go test ./..., or pytest -v tests/), not compile-only.
